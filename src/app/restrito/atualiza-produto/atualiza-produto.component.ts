...
export class AtualizaProdutoComponent implements OnInit{
  ...
  constructor(private _produtosService:ProdutoService, private _router: Router, 
    ...
    listarproduto():void{
      this._produtosService.getProduto(this.produtoId).subscribe(
        (res:any) => {
...
atualizar(id: number){
this._produtosService.atualizaProduto(id,this.produto).subscribe(
